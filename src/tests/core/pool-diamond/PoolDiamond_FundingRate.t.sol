...
contract PoolDiamond_FundingRateTest is PoolDiamond_BaseTest {
    ...
    external
  {
    ...
    // Close 2nd Long position entirely
    poolPerpTradeFacet.decreasePosition(
      address(this),
      1,
      address(wbtc),
    ...
    // = 180000 * 25 / 1000000 = 4.5 USD
    // fundingFeePayable = 0 + 4.5 = 4.5
    // fundingFeeReceivable = 0
    assertCloseWei(aumBefore, poolGetterFacet.getAum(true), 0.0002 * 10**30);
    assertEq(fundingFeePayable, 4.5 * 10**30);
    assertEq(fundingFeeReceivable, 0);
    ...
    // = 100000 * (-50) / 1000000 = -5 USD
    // fundingFeePayable = 0
    // fundingFeeReceivable = 5 - 4.5 = 0.5
    assertCloseWei(aumBefore, poolGetterFacet.getAum(true), 0.0002 * 10**30);
    assertEq(fundingFeePayable, 0);
