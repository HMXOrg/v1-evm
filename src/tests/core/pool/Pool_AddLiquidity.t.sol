...
contract Pool_AddLiquidity is Pool_BaseTest {
  ...
  function testCorrectness_WhenDynamicFeeOff_ViaRouter() external {
    // Mint 100 DAI to Alice
    dai.mint(ALICE, 100 ether);
  ...
  function testCorrectness_WhenDynamicFeeOn_ViaRouter() external {
    // Enable dynamic fee
    poolConfig.setIsDynamicFeeEnable(true);
  ...
  function testCorrectness_AddNativeToken_ViaRouter() external {
    // Enable dynamic fee
    poolConfig.setIsDynamicFeeEnable(true);
