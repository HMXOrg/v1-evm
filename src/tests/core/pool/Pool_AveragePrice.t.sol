...
import { Pool_BaseTest, Pool, console, PoolConfig } from "./Pool_BaseTest.t.sol";

contract Pool_AveragePriceTest is Pool_BaseTest {
  ...
  function testCorrectness_WhenPriceRefNotEqualsMarkPrice() external {
    ...
    // = 102.740698 USD
    assertEq(pool.liquidityOf(address(wbtc)), 274010);
    assertEq(pool.guaranteedUsdOf(address(wbtc)), 90.1 * 10**30);
    assertEq(pool.reservedOf(address(wbtc)), 247172);
    assertEq(pool.feeReserveOf(address(wbtc)), 990);
    assertEq(pool.poolMath().getAum18(pool, MinMax.MIN), 102.203938 * 10**18);
    assertEq(pool.poolMath().getAum18(pool, MinMax.MAX), 102.740698 * 10**18);
  ...
  function testCorrectness_WhenPriceRefEqualsMarkPrice() external {
    ...
    // = 102.202981 USD
    assertEq(pool.poolMath().getAum18(pool, MinMax.MIN), 102.202981 * 10**18);
    assertEq(pool.poolMath().getAum18(pool, MinMax.MAX), 102.202981 * 10**18);
    ...
    // = 90.1 + ((0.00274009 - 0.00247172) * 45100)
    // = 102.203487 USD
    assertEq(pool.liquidityOf(address(wbtc)), 274009);
    assertEq(pool.guaranteedUsdOf(address(wbtc)), 90.1 * 10**30);
    assertEq(pool.reservedOf(address(wbtc)), 247172);
    assertEq(pool.feeReserveOf(address(wbtc)), 991);
    assertEq(pool.poolMath().getAum18(pool, MinMax.MIN), 102.203487 * 10**18);
    assertEq(pool.poolMath().getAum18(pool, MinMax.MAX), 102.203487 * 10**18);
  ...
  function testCorrectness_WhenPriceRefLessThanAveragePrice() external {
    ...
    // = 80.09 + ((0.00274031 - 0.00225) * 36900)
    // = 98.182439 USD
    assertEq(pool.poolMath().getAum18(pool, MinMax.MIN), 98.182439 * 10**18);
    assertEq(pool.poolMath().getAum18(pool, MinMax.MAX), 98.182439 * 10**18);
    ...
    // = 80.875 + ((0.00299004 - 0.00252100) * 36900)
    // = 98.182576 USD
    assertEq(pool.liquidityOf(address(wbtc)), 299004);
    assertEq(pool.guaranteedUsdOf(address(wbtc)), 80.875 * 10**30);
    assertEq(pool.reservedOf(address(wbtc)), 252100);
    assertEq(pool.feeReserveOf(address(wbtc)), 996);
    assertEq(pool.poolMath().getAum18(pool, MinMax.MIN), 98.182576 * 10**18);
    assertEq(pool.poolMath().getAum18(pool, MinMax.MAX), 98.182576 * 10**18);
  ...
  function testCorrectness_WhenLong_WhenPriceRefEqualsAveragePrice() external {
    ...
    // 0.0025 * (1-0.003) * 40000 = 99.7 USD
    assertEq(pool.poolMath().getAum18(pool, MinMax.MIN), 99.7 * 10**18);
    assertEq(pool.poolMath().getAum18(pool, MinMax.MAX), 99.7 * 10**18);
    ...
    // = 80.09 + ((0.00274025 - 0.00225) * 40000)
    // = 99.7 USD
    assertEq(pool.liquidityOf(address(wbtc)), 0.00274025 * 10**8);
    assertEq(pool.guaranteedUsdOf(address(wbtc)), 80.09 * 10**30);
    assertEq(pool.reservedOf(address(wbtc)), 0.00225 * 10**8);
    assertEq(pool.feeReserveOf(address(wbtc)), 975);
    assertEq(pool.poolMath().getAum18(pool, MinMax.MIN), 99.7 * 10**18);
    assertEq(pool.poolMath().getAum18(pool, MinMax.MAX), 99.7 * 10**18);
    ...
    external
  {
    ...
    wbtc.mint(address(pool), 0.00125 * 10**8);
    pool.increasePosition(
      address(this),
      0,
      address(wbtc),
    ...
    // = 40.09 + ((0.00374025 - 0.00225) * 40000)
    // = 99.7 USD
    assertEq(pool.liquidityOf(address(wbtc)), 0.00374025 * 10**8);
    assertEq(pool.guaranteedUsdOf(address(wbtc)), 40.09 * 10**30);
    assertEq(pool.reservedOf(address(wbtc)), 0.00225 * 10**8);
    assertEq(pool.feeReserveOf(address(wbtc)), 975);
    assertEq(pool.poolMath().getAum18(pool, MinMax.MIN), 99.7 * 10**18);
    assertEq(pool.poolMath().getAum18(pool, MinMax.MAX), 99.7 * 10**18);
    ...
    external
  {
    ...
    pool.addLiquidity(address(this), address(matic), address(this));
  ...
  function testCorrectness_WhenShort_WhenPriceRefEqualsAveragePrice() external {
    ...
    dai.mint(address(pool), 101 * 10**18);
    ...
    // 2. Pool's AUM by max price should be:
    // 101 * (1-0.003) = 100.697 USD
    assertEq(pool.poolMath().getAum18(pool, MinMax.MIN), 100.697 * 10**18);
    assertEq(pool.poolMath().getAum18(pool, MinMax.MAX), 100.697 * 10**18);

    // Open a 90 USD WBTC short position with 50 DAI as a collateral
    dai.mint(address(pool), 50 * 10**18);
    pool.increasePosition(
      address(this),
      0,
      address(dai),
    ...
    assertEq(pool.liquidityOf(address(dai)), 100.697 * 10**18);
    assertEq(pool.feeReserveOf(address(dai)), 0.393 * 10**18);
    ...
    external
  {
    ...
    // = 100.697 + (90 * ((50000 - 40000) / 40000))
    // = 123.197
    assertEq(pool.poolMath().getAum18(pool, MinMax.MIN), 123.197 * 10**18);
    assertEq(pool.poolMath().getAum18(pool, MinMax.MAX), 123.197 * 10**18);
    ...
    external
  {
    ...
    // = 100.697 + (90 * ((30000 - 40000) / 40000))
    // = 78.197
    assertEq(pool.poolMath().getAum18(pool, MinMax.MIN), 78.197 * 10**18);
    assertEq(pool.poolMath().getAum18(pool, MinMax.MAX), 78.197 * 10**18);
    ...
    external
  {
    ...
    // = 100.697 + (90 * ((39700 - 40000) / 40000))
    // = 100.022
    assertEq(pool.poolMath().getAum18(pool, MinMax.MIN), 100.022 * 10**18);
    assertEq(pool.poolMath().getAum18(pool, MinMax.MAX), 100.022 * 10**18);
    ...
    assertEq(
      pool.shortAveragePriceOf(address(wbtc)),
    ...
    // = 100.697 + (100 * ((39000 - 39969.79612383589) / 39969.79612383589))
    // = 98.27067758186398
    assertEq(pool.poolMath().getAum18(pool, MinMax.MIN), 98270677581863979848);
    assertEq(pool.poolMath().getAum18(pool, MinMax.MAX), 98270677581863979848);
